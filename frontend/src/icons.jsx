...
export const MessageIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M21 12a9 9 0 1 0-16 6.3V21l4.7-2.4A9 9 0 0 0 21 12z" />
  </svg>
)

export const PhoneIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2A18 18 0 0 1 3.1 5.18a2 2 0 0 1 2-2h3a2 2 0 0 1 2 1.72c.1.8.3 1.6.6 2.36a2 2 0 0 1-.45 2L9.5 11a16 16 0 0 0 6 6l1.74-1.74a2 2 0 0 1 2-.45c.76.3 1.56.5 2.37.6a2 2 0 0 1 1.72 2z" />
  </svg>
)
...
export const FriendsIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M2 21c0-3 3-6 6-6" />
    <path d="M12 19c0-2.5 2.5-4.5 5-4" />
  </svg>
)

export const CommunitiesIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <circle cx="6" cy="8" r="3" />
    <circle cx="12" cy="5" r="3" />
    <circle cx="18" cy="8" r="3" />
    <path d="M2 21c0-2.5 2.5-5 5-5" />
    <path d="M9 21c0-2.5 3-5 6-5" />
    <path d="M16 21c0-2.5 2.5-5 5-5" />
  </svg>
)
